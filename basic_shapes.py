...
#------------------------------------------------------------------------------------
def createTextureQuadGif(image_filename1, image_filename2, tiempo, t, nx=1, ny=1):
    if tiempo%t!=0:
        print("true")
        # Defining locations and texture coordinates for each vertex of the shape    
        vertices = [
        ...
        textureFileName = image_filename1
        ...
        textureFileName = image_filename2
